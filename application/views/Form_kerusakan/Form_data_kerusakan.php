    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-user"></i> Data Kerusakan Alat</h2>

                <div class="box-icon">
                    <a href="#" class="btn addKerusakan btn-round btn-default"><i class="glyphicon glyphicon-plus-sign"></i></a>
...
<?php include "Form_add_kerusakan.php"; ?>

<script>
    $('.addKerusakan').click(function(e) {
        e.preventDefault();
        $('#addKerusakan').modal('show');
    });
