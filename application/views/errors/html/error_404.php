...
.bg-purple{
    background: url(http://localhost/Silab_UGM/assets/img/error/bg_purple.png) !important;
...
.stars{
    background: url(http://localhost/Silab_UGM/assets/img/error/overlay_stars.svg);
